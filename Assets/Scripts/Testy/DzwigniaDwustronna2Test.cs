...
public class DzwigniaDwustronna2Test: MonoBehaviour {
	...
	public void calculateF() {
        object[]    data    =   module_ui.GetComponent<DzwigniaDwustronna2TUI>().getData();
        var cubeAScale      =   object_cube1.transform.localScale;
        var cubeBScale      =   object_cube2.transform.localScale;
        ...
        module_ui.GetComponent<DzwigniaDwustronna2TUI>().updateData( f1, f2, d1, d2 );
    }
